...
<!-- responsive style -->
<link href="${rootPath}/css/responsive.css" rel="stylesheet" />
...
<script src="https://code.jquery.com/jquery-latest.js"></script><script type="text/javascript" charset="UTF-8" src="https://maps.googleapis.com/maps-api-v3/api/js/54/2/intl/ko_ALL/common.js"></script>
